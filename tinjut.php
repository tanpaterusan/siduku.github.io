...
$aduan = query("SELECT * FROM tb_aduan WHERE `status`!='baru'");

if (isset($_POST["submit"])) {
    if (tinjut($_POST) > 0) {
        echo "<script>
                alert('pengaduan berhasil ditindaklanjuti');
                window.location.href='tinjut.php';
            </script>";
    } else {
        echo  "<script>
                alert('pengaduan gagal ditindaklanjuti!');
             </script>";
    }
}
...
<div class="masthead align-items-center">
    <div class="container col-lg-6">
        ...
        <div class="card text-dark bg-light mb-3">
            <div class="card-header">Pengaduan yang Ditindaklanjuti Per <?= date('d F Y'); ?></div>
            <div class="card-body">
                <h5 class="card-title text-center">Halaman Tindak Lanjut</h5>
                <br>
                    ...
                    <?php foreach ($aduan as $a) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning tinjut" data-bs-toggle="modal" data-bs-target="#tinjutModal" data-id="<?= $a['id']; ?>" data-status="<?= $a['status']; ?>"> verifikasi </a>
                            </td>
                            <td>
...
<!-- Modal Tinjut -->
<div class="modal fade" id="tinjutModal" tabindex="-1" aria-labelledby="tinjutModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tinjutModalLabel">Tindak Lanjut Aduan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="tinjut-modal">
